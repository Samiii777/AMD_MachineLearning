...
wget -r -np -nH --cut-dirs=4 -P /tmp/ https://repo.radeon.com/amdgpu-install/6.3.2/ubuntu/jammy/amdgpu-install_6.3.60302-1_all.deb

# Install AMD Driver Package
apt-get install -y /tmp/amdgpu-install_6.3.60302-1_all.debb
